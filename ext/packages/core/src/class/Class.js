...
// @require Ext.util.Cache
    ...
    /**
     * @cfg {Object} statics
     * Feladatok of static methods for this class. For example:
     *
     *     Ext.define('Computer', {
     *          statics: {
     *              factory: function(brand) {
     ...
     * Feladatok of inheritable static methods for this class.
     ...
     * @cfg {Object} config
     *
     * Feladatok of configuration options with their default values.
     *
     ...
     * Feladatok of classes to mix into this class. For example:
     *
     *     Ext.define('CanSing', {
     *          sing: function() {
