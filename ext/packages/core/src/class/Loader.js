...
// @require Ext.env.Ready
     ...
     * @cfg {String[]} requires
     * @member Ext.Class
     * Feladatok of classes that have to be loaded before instantiating this class.
     * For example:
     *
     *     Ext.define('Mother', {
     *         requires: ['Child'],
     ...
     * @cfg {String[]} uses
     * @member Ext.Class
     * Feladatok of optional classes to load together with this class. These aren't neccessarily loaded
