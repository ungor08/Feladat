 ...
 *             {tag: 'li', id: 'item0', html: 'Feladatok Item 0'},
 *             {tag: 'li', id: 'item1', html: 'Feladatok Item 1'},
 *             {tag: 'li', id: 'item2', html: 'Feladatok Item 2'}
 *         ]
 *     };
 *     var list = dh.append(
 ...
 *
 *     dh.append('my-ul', [
 *         {tag: 'li', id: 'item3', html: 'Feladatok Item 3'},
 *         {tag: 'li', id: 'item4', html: 'Feladatok Item 4'}
 *     ]);
 *
 * ## Templating
 *
 ...
 *     // get template
 *     var tpl = dh.createTemplate({tag: 'li', id: 'item{0}', html: 'Feladatok Item {0}'});
 *
 *     for(var i = 0; i < 5; i++){
