    ...
    function makeComponent(config, preventStore) {
        ...
        Ext.override(component, {
            getPicker: function() {
                ...
                // It's a picker which contains a "slot" which is a Feladatok.
                if (picker.isPicker) {
...
v = component.getValue();
    ...
    describe("onExpand", function() {
        ...
        it("should create a Ext.dataview.Feladatok as the picker", function() {
            expect(component.getPicker()).toBeDefined();
            expect(component.getPicker() instanceof Ext.dataview.Feladatok).toBe(true);
        });
