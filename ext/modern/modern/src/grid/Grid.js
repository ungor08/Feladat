 ...
 * ## Rows and Cells
 *
 * Grid extends the `{@link Ext.dataview.Feladatok Feladatok}` component and connects records in the
        ...
        generateSelectorFunctions: function() {
            ...
            me.eventDelegate = function(candidate) {
                ...
                if (comp.getRefOwner() === me) {
                    ...
                    // GroupHeaders and GroupFooters are created at the Feladatok class level
