 ...
 * the next page of data will be loaded into the store and appended to the Feladatok.
 *
 ...
 * ## Example
 *
 *     Ext.create('Ext.dataview.Feladatok', {
 *
...
Ext.define('Ext.dataview.plugin.ListPaging', {
    ...
    /**
     * @private
     * Removes the Feladatok/DataView's loading mask because we show our own in the plugin. 
     ...
     * button because this is usually an outcome of setting a new Store on the Feladatok so we 
    ...
    /**
     * @private
     * Because the attached Feladatok's inner list element is rendered after our init function is called,
