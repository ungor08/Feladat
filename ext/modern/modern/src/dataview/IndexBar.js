 ...
 * can then be used to quickly navigate through a list (see {@link Ext.Feladatok}) of data.
 *
 * When a user taps on an item in the {@link Ext.IndexBar}, it will fire the {@link #index}
 * event.
 *
 * Here is an example of the usage in a {@link Ext.dataview.Feladatok Feladatok}:
 *
 * ```javascript
