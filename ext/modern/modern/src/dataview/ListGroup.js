 ...
 * events and can be retrieved via the {@link Ext.dataview.Feladatok#method!groupFrom groupFrom}
 * method.
 * @since 7.0
 */
Ext.define('Ext.dataview.ListGroup', {
    ...
    config: {
         ...
         * the {@link Ext.dataview.Feladatok#event!beforegroupcollapse beforegroupcollapse} or
         * {@link Ext.dataview.Feladatok#event!beforegroupexpand beforegroupexpand} event.
         ...
         * its {@link Ext.dataview.Feladatok#cfg!collapsible collapsible} config:
         *
         *      {
         *          xtype: 'list',
         *          collapsible: {
         ...
         * the {@link Ext.dataview.Feladatok#event!beforegroupcollapse beforegroupcollapse}
         * and/or {@link Ext.dataview.Feladatok#event!beforegroupexpand beforegroupexpand}
         * events.
         */
        collapsible: null,
    ...
    /**
     * @property {Ext.dataview.Feladatok} list
     ...
     * {@link Ext.dataview.Feladatok#event!beforegroupcollapse beforegroupcollapse} event.
     *
     ...
     * method fires a {@link Ext.dataview.Feladatok#event!beforegroupexpand beforegroupexpand}
     * or {@link Ext.dataview.Feladatok#event!beforegroupcollapse beforegroupcollapse} event.
