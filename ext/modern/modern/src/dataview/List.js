/**
 * Feladatok is a vertical `DataView` which additionally supports {@link #grouped grouping},
 ...
 * ## Scroll Docking
 *
 * If you want to dock items to the bottom or top of a Feladatok, you can use the `scrollDock`
 * configuration on child items in this Feladatok. The following example adds a button to the
 * bottom of the Feladatok.
 *
 * ```javascript
 * @example({ framework: 'extjs' })
 * Ext.create({
 ...
 *
 */
Ext.define('Ext.dataview.Feladatok', {
    extend: 'Ext.dataview.Component',
    alternateClassName: 'Ext.Feladatok',
     ...
     * @param {Ext.dataview.Feladatok} this
     ...
     * @param {Ext.dataview.Feladatok} this This list.
     ...
     * @param {Ext.dataview.Feladatok} list The Feladatok instance
    ...
    updateUseSimpleItems: function(useSimpleItems) {
        ...
        if (!this.self._updateUseSimpleItemsWarning) {
            ...
            Ext.log.warn('The Ext.Feladatok#useSimpleItems config is deprecated; ' +
    ...
    privates: {
        // This is a selector which excludes Tool elements from triggering Feladatok child
        // events. Clicks on Tools are handled entirely by the Tool and do not cause
        // Feladatok child events. Tools which are configured passive: true are excluded from this;
        ...
        syncPinnedHorz: function(item) {
            ...
            /*
                ...
                so, we need to be sure, if current Feladatok is horizontally scrollable and 
