 ...
 * this class in version 6.5 as part of the numerous {@link Ext.dataview.Feladatok Feladatok} and
    ...
    privates: {
        ...
        acquireItem: function(cfg, itemsFocusable) {
            ...
            if (!(item = me.itemCache.unused.pop())) {
                ...
                // FocusableContainer relationship with the Feladatok's container,
        ...
        addDataItem: function(item, at) {
            ...
            me.dataItems.push(item); // if this changes, check Feladatok.dislodgeItem
        ...
        changeItem: function(itemIndex, recordIndex) {
            ...
            // To cope with Feladatok headers and footers, we track beforeEl and afterEl
