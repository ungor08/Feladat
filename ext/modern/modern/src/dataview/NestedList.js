...
Ext.define('Ext.dataview.NestedList', {
    ...
    config: {
         ...
         * Maps to the {@link Ext.Feladatok#onItemDisclosure} configuration for individual lists.
         * @accessor
         */
     ...
     * @param {Ext.dataview.Feladatok} list The Ext.dataview.Feladatok that is currently active.
     ...
     * @param {Ext.dataview.NestedList} this
     * @param {Ext.Feladatok} list The subList the item is on.
     * @param {Number} index The index of the item tapped.
     * @param {Ext.dom.Element} target The element tapped.
     * @param {Ext.data.Record} record The record tapped.
     ...
     * @param {Ext.dataview.NestedList} this
     * @param {HTMLElement} node The node to be selected.
     * @param {Ext.dataview.Feladatok} lastActiveList The Ext.dataview.Feladatok that was last active.
    ...
    goToLeaf: function(node) {
        ...
        if (card) {
            ...
            if (sharedContainer) {
                ...
                if (activeItem instanceof Ext.dataview.Feladatok) {
                    me.setLastActiveList(activeItem);
                }
    ...
    privates: {
        /**
         * @private
         * This method will change the toolbar title without changing the Feladatok title.
         */
