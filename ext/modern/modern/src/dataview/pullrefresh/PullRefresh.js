 ...
 * {@link Ext.dataview.Feladatok list} component.
 *
 * ## Example
 *
 * ```javascript
...
Ext.define('Ext.dataview.pullrefresh.PullRefresh', {
    ...
    config: {
        ...
        /**
         * @cfg {Ext.dataview.Feladatok} list
    ...
    privates: {
        ...
        /**
         * Attempts to load the newest posts via the attached Feladatok's Store's Proxy
         * @private
         */
        ...
        /**
         * Snaps the Feladatok back to the top after a pullrefresh is complete
