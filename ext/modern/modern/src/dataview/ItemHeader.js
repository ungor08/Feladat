/**
 * A simple header component for grouped lists.  Feladatok headers are created automatically
 * by {@link Ext.dataview.Feladatok Lists} and should not be directly instantiated.
 */
