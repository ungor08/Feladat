 ...
 * 
 * Feladatok filters are able to be preloaded/backed by an Ext.data.Store to load
 ...
 *
 * Example Feladatok Filter Usage:
 *
 *     @example
 ...
 *     });
 */
Ext.define('Ext.grid.filters.filter.Feladatok', {
    ...
    getFilterConfig: function(config, key) {
        // Feladatok filter needs to have its value set immediately or else could will fail
