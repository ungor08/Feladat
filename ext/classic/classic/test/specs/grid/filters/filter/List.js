topSuite("Ext.grid.filters.filter.Feladatok", ['Ext.grid.Panel', 'Ext.grid.filters.Filters'], function() {
    ...
    describe("binding the grid store listeners", function() {
        ...
        beforeEach(function() {
            oldGridStoreListenersCfg = Ext.grid.filters.filter.Feladatok.prototype.gridStoreListenersCfg;
            Ext.grid.filters.filter.Feladatok.prototype.gridStoreListenersCfg = {
                add: 'onDataChanged',
        ...
        afterEach(function() {
            Ext.grid.filters.filter.Feladatok.prototype.gridStoreListenersCfg = oldGridStoreListenersCfg;
    ...
    describe("list items", function() {
        ...
        describe("passing config.value", function() {
            describe("empty array", function() {
                ...
                it("should set the Feladatok filter as active", function() {
